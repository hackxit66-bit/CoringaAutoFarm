...
local tamanhoOriginal = UDim2.new(0, 500, 0, 380)
...
btnIniciar.Size = UDim2.new(0, 110, 0, 45)
...
btnVelocidade.Size = UDim2.new(0, 110, 0, 45)
btnVelocidade.Position = UDim2.new(0, 120, 0, 55)
...
btnTimes.Size = UDim2.new(0, 110, 0, 45)
btnTimes.Position = UDim2.new(0, 240, 0, 55)
...
-- NOVO BOTÃO: TP (Teleport)
local btnTP = Instance.new("TextButton")
btnTP.Size = UDim2.new(0, 110, 0, 45)
btnTP.Position = UDim2.new(0, 360, 0, 55)
btnTP.BackgroundColor3 = Color3.fromRGB(0, 100, 200)
btnTP.Text = "👤 TP"
...
-- NOVO: Caixa de TP (invisível inicialmente)
local tpBox = Instance.new("Frame")
tpBox.Size = UDim2.new(0, 470, 0, 100)
tpBox.Position = UDim2.new(0, 0, 0, 110)
