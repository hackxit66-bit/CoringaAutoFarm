...
function criarBotoesVoo()
    ...
    -- Botão CIMA
    local btnCima = Instance.new("TextButton")
    btnCima.Size = UDim2.new(0, 70, 0, 70)
    btnCima.Position = UDim2.new(0.1, -35, 0.35, -35)
    btnCima.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    btnCima.Text = textos[idiomaAtual].cima
    btnCima.TextColor3 = Color3.fromRGB(255, 255, 255)
    btnCima.TextSize = 12
    btnCima.Font = Enum.Font.GothamBold
    btnCima.Parent = vooGui
    Instance.new("UICorner", btnCima).CornerRadius = UDim.new(0, 10)
    
    btnCima.MouseButton1Click:Connect(function()
        local root = getRoot()
        if root and vooAtivo then
            root.CFrame = root.CFrame + Vector3.new(0, 0, -10)
        end
    end)
    
    -- Botão BAIXO
    local btnBaixo = Instance.new("TextButton")
    btnBaixo.Size = UDim2.new(0, 70, 0, 70)
    btnBaixo.Position = UDim2.new(0.1, -35, 0.55, -35)
    btnBaixo.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    btnBaixo.Text = textos[idiomaAtual].baixo
    btnBaixo.TextColor3 = Color3.fromRGB(255, 255, 255)
    btnBaixo.TextSize = 12
    btnBaixo.Font = Enum.Font.GothamBold
    btnBaixo.Parent = vooGui
    Instance.new("UICorner", btnBaixo).CornerRadius = UDim.new(0, 10)
    
    btnBaixo.MouseButton1Click:Connect(function()
        local root = getRoot()
        if root and vooAtivo then
            root.CFrame = root.CFrame + Vector3.new(0, 0, 10)
        end
    ...
    btnEsquerda.Size = UDim2.new(0, 70, 0, 70)
    btnEsquerda.Position = UDim2.new(0.02, 0, 0.45, -35)
    btnEsquerda.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    btnEsquerda.Text = textos[idiomaAtual].esquerda
    btnEsquerda.TextColor3 = Color3.fromRGB(255, 255, 255)
    btnEsquerda.TextSize = 12
    btnEsquerda.Font = Enum.Font.GothamBold
    btnEsquerda.Parent = vooGui
    Instance.new("UICorner", btnEsquerda).CornerRadius = UDim.new(0, 10)
    
    btnEsquerda.MouseButton1Click:Connect(function()
        local root = getRoot()
        if root and vooAtivo then
            root.CFrame = root.CFrame + Vector3.new(-10, 0, 0)
        end
    end)
    
    -- Botão DIREITA
    local btnDireita = Instance.new("TextButton")
    btnDireita.Size = UDim2.new(0, 70, 0, 70)
    btnDireita.Position = UDim2.new(0.18, 0, 0.45, -35)
    btnDireita.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    btnDireita.Text = textos[idiomaAtual].direita
    btnDireita.TextColor3 = Color3.fromRGB(255, 255, 255)
    btnDireita.TextSize = 12
    btnDireita.Font = Enum.Font.GothamBold
    btnDireita.Parent = vooGui
    Instance.new("UICorner", btnDireita).CornerRadius = UDim.new(0, 10)
    
    btnDireita.MouseButton1Click:Connect(function()
        local root = getRoot()
        if root and vooAtivo then
            root.CFrame = root.CFrame + Vector3.new(10, 0, 0)
        end
    ...
    btnSubir.Position = UDim2.new(0.85, -40, 0.35, -35)
    ...
    btnDescer.Position = UDim2.new(0.85, -40, 0.55, -35)
    ...
    spawn(function()
        while getgenv().CoringaFarm.AndarAgua do
            ...
            if root and humanoid then
                if not blocoAgua then
                    blocoAgua = Instance.new("Part")
                    blocoAgua.Anchored = true
                    blocoAgua.Size = Vector3.new(5, 1, 5)
                    blocoAgua.Transparency = 1
                    blocoAgua.CanCollide = true
                    blocoAgua.Parent = Workspace
                end
                
                blocoAgua.CFrame = root.CFrame - Vector3.new(0, 3, 0)
...
for i, corInfo in pairs(coresTimes) do
    ...
    posX = posX + 75
    colunas = colunas + 1
    if colunas == 2 then colunas = 0 posX = 5 posY = posY + 27 end
end
...
for i, idioma in pairs(idiomas) do
    ...
    btnIdioma.MouseButton1Click:Connect(function()
        ...
        atualizarIdioma()
        for _, btn in pairs(idiomaBotoes) do btn.BackgroundColor3 = Color3.fromRGB(50, 50, 60) end
...
function criarBotoesPlayer()
    ...
    local functions = {
        ...
        {nome = textos[idiomaAtual].vooNome, var = "Voo", tipo = "toggle"},
...
function criarBotoesEfeitos()
    for _, child in pairs(efeitosLista:GetChildren()) do child:Destroy() end
...
function atualizarIdioma()
    ...
    if mostrandoEfeitos then rightTitle.Text = textos[idiomaAtual].efeitosNome
    elseif mostrandoOpcoesJogador and jogadorSelecionado then rightTitle.Text = jogadorSelecionado.Name
    elseif mostrandoTimes then rightTitle.Text = textos[idiomaAtual].timesTitulo
    elseif mostrandoPlayers then rightTitle.Text = textos[idiomaAtual].playerTitulo
    elseif mostrandoConfig then rightTitle.Text = textos[idiomaAtual].configTitulo
    else rightTitle.Text = textos[idiomaAtual].jogadores end
    ...
    for i, btn in pairs(idiomaBotoes) do
        ...
        elseif i == 3 then btn.Text = textos[idiomaAtual].espanholOpcao end
    end
end
...
function minimizarMenu()
    ...
    if menuMinimizado then botaoFlutuante.Visible = true btnMinimizar.Text = "⬜"
    else botaoFlutuante.Visible = false btnMinimizar.Text = "➖" end
end
...
btnVelocidade.MouseButton1Click:Connect(function()
    if getgenv().CoringaFarm.Teleport == 2 then getgenv().CoringaFarm.Teleport = 0.5 btnVelocidade.Text = textos[idiomaAtual].velRapida
    elseif getgenv().CoringaFarm.Teleport == 0.5 then getgenv().CoringaFarm.Teleport = 3 btnVelocidade.Text = textos[idiomaAtual].velLenta
    else getgenv().CoringaFarm.Teleport = 2 btnVelocidade.Text = textos[idiomaAtual].velocidade end
end)

btnTimes.MouseButton1Click:Connect(function()
    mostrandoEfeitos = false efeitosLista.Visible = false
    if mostrandoOpcoesJogador then opcoesLista.Visible = false mostrandoOpcoesJogador = false end
    if mostrandoTimes then
        mostrandoTimes = false mostrandoPlayers = false mostrandoConfig = false mostrandoJogadores = true
        jogadoresLista.Visible = true timesLista.Visible = false playerLista.Visible = false configLista.Visible = false
        rightTitle.Text = textos[idiomaAtual].jogadores
        btnTimes.Text = textos[idiomaAtual].times
        btnPlayer.Text = textos[idiomaAtual].player
        btnConfig.Text = textos[idiomaAtual].config
        ...
        mostrandoTimes = true mostrandoPlayers = false mostrandoConfig = false mostrandoJogadores = false
        jogadoresLista.Visible = false timesLista.Visible = true playerLista.Visible = false configLista.Visible = false opcoesLista.Visible = false
...
btnPlayer.MouseButton1Click:Connect(function()
    ...
    if mostrandoPlayers then
        mostrandoPlayers = false mostrandoTimes = false mostrandoConfig = false mostrandoJogadores = true
        jogadoresLista.Visible = true timesLista.Visible = false playerLista.Visible = false configLista.Visible = false
        rightTitle.Text = textos[idiomaAtual].jogadores
        btnPlayer.Text = textos[idiomaAtual].player
        btnTimes.Text = textos[idiomaAtual].times
        ...
        mostrandoPlayers = true mostrandoTimes = false mostrandoConfig = false mostrandoJogadores = false
        jogadoresLista.Visible = false timesLista.Visible = false playerLista.Visible = true configLista.Visible = false opcoesLista.Visible = false
        rightTitle.Text = textos[idiomaAtual].playerTitulo
...
btnConfig.MouseButton1Click:Connect(function()
    ...
    if mostrandoConfig then
        mostrandoConfig = false mostrandoPlayers = false mostrandoTimes = false mostrandoJogadores = true
        jogadoresLista.Visible = true timesLista.Visible = false playerLista.Visible = false configLista.Visible = false
        rightTitle.Text = textos[idiomaAtual].jogadores
        btnConfig.Text = textos[idiomaAtual].config
        btnTimes.Text = textos[idiomaAtual].times
        ...
        mostrandoConfig = true mostrandoPlayers = false mostrandoTimes = false mostrandoJogadores = false
        jogadoresLista.Visible = false timesLista.Visible = false playerLista.Visible = false configLista.Visible = true opcoesLista.Visible = false
...
btnFechar.MouseButton1Click:Connect(function() 
    farmAtivo = false farmCancelado = true
    getgenv().CoringaFarm.Enabled = false 
    limparEfeitos()
    destruirBotoesVoo()
    if blocoAgua then blocoAgua:Destroy() end
    screenGui:Destroy() 
end)

spawn(function() while true do wait(1) if farmAtivo then temporizador = temporizador + 1 end atualizarUI() end end)
spawn(function() while true do wait(3) if mostrandoJogadores then verJogadoresProximos() end end end)
