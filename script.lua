...
-- =============================================
-- FUNÇÃO ESP (VER ATRAVÉS DE PAREDES)
-- =============================================

function criarESP(jogador)
    if not jogador.Character then return end
    
    -- Criar Highlight (contorno brilhante)
    ...
    -- Criar Billboard (nome e distância)
...
-- BOTÕES DO MENU PRINCIPAL (SEM TIMES)
...
-- =============================================
-- PAINEL DIREITO (JOGADORES / PLAYER / CONFIG)
-- =============================================
...
-- FUNÇÃO PARA CRIAR BOTÕES DO PLAYER (COM ESP)
