...
local textos = {
    ...
    espanol = {
        ...
        visaoNoturnaNome = " Vision Nocturna",
        efeitosNome = " Efectos",
        noclipNome = " NoClip",
        vidaInfinitaNome = " Vida Infinita",
        modoAmigoNome = " Modo Amigo",
...
-- LISTA DE PLAYER (COM AS NOVAS FUNÇÕES)
