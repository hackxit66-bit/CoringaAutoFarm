...
-- LISTA DE PLAYER (COM EFEITO COMO BOTAO QUE ABRE SUBMENU)
...
local function criarBotoesPlayer()
    ...
    local functions = {
        ...
        {nome = textos[idiomaAtual].efeitosNome, var = "Efeitos", tipo = "menu"}, -- ESSE ABRE SUBMENU
...
local function criarBotoesEfeitos()
    ...
    efeitosLista.CanvasSize = UDim2.new(0, 0, 0, yPos + 40)
