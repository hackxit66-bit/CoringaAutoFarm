...
function autoFarm(currentRun)
    ...
    -- PASSA POR TODAS AS 10 FASES (IGUAL AO CÓDIGO ANTIGO)
    for i = 1, 10 do
    ...
    -- VAI PARA O BAÚ FINAL (CORRIGIDO)
...
botoesFrame.Size = UDim2.new(1, 0, 0, 130)
...
-- LISTA DE PLAYER (COM ESCUDO INCLUÍDO)
...
-- BOTÃO PLAYER (COM ESCUDO DENTRO)
