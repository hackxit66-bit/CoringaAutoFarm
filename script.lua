...
local espObjetos = {}
local ultimaPos = Vector3.new()
local forcarMovimento = false

-- =============================================
-- CORES DOS TEMAS (APENAS PARA O FUNDO)
-- =============================================
local coresFundo = {
    ["🔵 Azul"] = Color3.fromRGB(20, 30, 45),
    ["🟢 Verde"] = Color3.fromRGB(20, 45, 20),
    ["🔴 Vermelho"] = Color3.fromRGB(45, 20, 20),
    ["🟡 Amarelo"] = Color3.fromRGB(45, 45, 20),
    ["💗 Rosa"] = Color3.fromRGB(45, 20, 30),
    ["🟣 Roxo"] = Color3.fromRGB(30, 20, 45)
}
...
local textos = {
    portugues = {
        ...
        velocidadeForcadaNome = "⚡ Vel Forçada",
    ...
    english = {
        ...
        velLenta = "🐢 SLOW SPEED",
        velocidadeForcada = "⚡ FORCED SPEED",
        player = "👤 PLAYER",
        ...
        velocidadeForcadaNome = "⚡ Forced Speed",
    ...
    espanol = {
        ...
        velocidadeForcadaNome = "⚡ Vel Forzada",
        invisivelNome = "👻 Invisible",
...
-- VELOCIDADE FORÇADA (ANTI-TRAVA)
function velocidadeForcadaLoop()
    spawn(function()
        local bodyVelocity = Instance.new("BodyVelocity")
        bodyVelocity.MaxForce = Vector3.new(4000, 0, 4000)
        bodyVelocity.Velocity = Vector3.new(0, 0, 0)
        
        ultimaPos = getRoot() and getRoot().Position or Vector3.new()
        
        while getgenv().CoringaFarm.VelocidadeForcada do
            local root = getRoot()
            local humanoid = getHumanoid()
            ...
            if root and humanoid then
                ...
                -- Se está tentando andar
                if moveDir.Magnitude > 0 then
                    -- Verifica se está travado
                    if (root.Position - ultimaPos).Magnitude < 0.5 then
                        -- Força teleporte
                        root.CFrame = root.CFrame + moveDir * 15
                    else
                        -- Usa BodyVelocity
...
function aplicarTema(tema)
    local corFundo = coresFundo[tema]
    if not corFundo then return end
...
frame.BackgroundColor3 = coresFundo[temaAtual]
...
btnIdioma.Size = UDim2.new(0.8, 0, 0, 30)
btnIdioma.Position = UDim2.new(0.1, 0, 0.05, 0)
btnIdioma.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
...
btnTemas.Size = UDim2.new(0.8, 0, 0, 30)
btnTemas.Position = UDim2.new(0.1, 0, 0.15, 0)
btnTemas.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
btnTemas.Text = textos[idiomaAtual].temas
btnTemas.TextColor3 = Color3.fromRGB(255, 255, 255)
...
idiomaLista.Size = UDim2.new(1, -10, 0, 110)
...
for i, idioma in ipairs(idiomasOpcoes) do
    ...
    btn.Position = UDim2.new(0.1, 0, 0.05 + (i-1)*0.12, 0)
    btn.BackgroundColor3 = idioma.id == idiomaAtual and Color3.fromRGB(0, 150, 0) or Color3.fromRGB(80, 80, 80)
...
btnVoltarIdioma.Size = UDim2.new(0.8, 0, 0, 25)
btnVoltarIdioma.Position = UDim2.new(0.1, 0, 0.41, 0)
...
temasLista.Size = UDim2.new(1, -10, 0, 220)
...
for i, tema in ipairs(temasOpcoes) do
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0.8, 0, 0, 25)
    btn.Position = UDim2.new(0.1, 0, 0.05 + (i-1)*0.09, 0)
    btn.BackgroundColor3 = tema == temaAtual and Color3.fromRGB(0, 150, 0) or Color3.fromRGB(80, 80, 80)
    btn.Text = tema
    btn.TextColor3 = Color3.fromRGB(255, 255, 255)
    btn.TextSize = 11
    btn.Font = Enum.Font.GothamBold
...
btnVoltarTemas.Size = UDim2.new(0.8, 0, 0, 25)
btnVoltarTemas.Position = UDim2.new(0.1, 0, 0.6, 0)
...
-- FUNÇÃO PARA CRIAR BOTÕES DO PLAYER (COM VELOCIDADE FORÇADA)
function criarBotoesPlayer()
    ...
    local functions = {
        ...
        {nome = textos[idiomaAtual].velocidadeForcadaNome, var = "VelocidadeForcada"},
    ...
    for i, func in pairs(functions) do
        ...
        btnToggle.MouseButton1Click:Connect(function()
            ...
            elseif func.var == "VelocidadeForcada" then velocidadeForcadaLoop()
