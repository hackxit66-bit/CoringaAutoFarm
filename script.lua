...
function autoFarm(currentRun)
    ...
    -- PASSA POR TODAS AS 10 FASES (IGUAL AO GITHUB)
    for i = 1, 10 do
        ...
        if Stage then
            ...
            if DarknessPart then
                -- Teleporta para a parte escura
                Character.HumanoidRootPart.CFrame = DarknessPart.CFrame
                
                -- CRIA PARTE TEMPORÁRIA (TRUQUE DO GITHUB)
    ...
    -- VAI PARA O BAÚ (IGUAL AO GITHUB)
    ...
    -- AGUARDA RESPAWN (IGUAL AO GITHUB)
    if farmAtivo and not farmCancelado then
