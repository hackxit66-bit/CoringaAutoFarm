            ...
            if GoldenChest then
                ...
                if Trigger then
                    ...
                    repeat 
                        ...
                        if tempoMaximo > 50 then break end
...
local playerFunctions = {
    {nome = " Velocidade", var = "Velocidade"},
    {nome = " Invisível", var = "Invisivel"},
    {nome = " Super Pulo", var = "SuperPulo"},
    {nome = " Escudo", var = "Escudo"}
}
...
-- LISTA DE CONFIGURAÇÃO (IDIOMAS)
local configLista = Instance.new("Frame")
configLista.Size = UDim2.new(1, -10, 0, 140)
...
for i, idioma in pairs(idiomas) do
    ...
    btnIdioma.MouseButton1Click:Connect(function()
        ...
        for _, child in pairs(configLista:GetChildren()) do
            if child:IsA("TextButton") and child ~= btnVoltar then
...
btnVoltar = Instance.new("TextButton")
btnVoltar.Size = UDim2.new(1, -10, 0, 30)
btnVoltar.Position = UDim2.new(0, 5, 0, yPosConfig + 5)
...
function atualizarIdioma()
    ...
    if configLista then
        for i, child in pairs(configLista:GetChildren()) do
            if child:IsA("TextButton") then
                if child.Text == " Português" or child.Text == " Portuguese" or child.Text == " Portugués" then
                    child.Text = textos[idiomaAtual].portuguesOpcao
                elseif child.Text == " English" or child.Text == " Inglés" then
                    child.Text = textos[idiomaAtual].inglesOpcao
                elseif child.Text == " Español" or child.Text == " Spanish" then
                    child.Text = textos[idiomaAtual].espanholOpcao
                elseif child.Text == " VOLTAR" or child.Text == " BACK" or child.Text == " VOLVER" then
                    child.Text = textos[idiomaAtual].voltar
                end
            end
        end
    end
