...
-- =============================================
-- FUNÇÃO DE FARM CORRIGIDA (BAÚ FUNCIONANDO)
-- =============================================
...
function autoFarm(currentRun)
    ...
    -- VAI PARA O BAÚ (CORRIGIDO - SEM TEMPO MÁXIMO)
...
-- LISTA DE PLAYER (COM TEXTOS QUE MUDAM COM IDIOMA)
...
local function criarBotoesPlayer()
    ...
    for i, func in pairs(functions) do
        ...
        table.insert(playerBotoes, {bg = bg, toggle = btnToggle})
        yPos = yPos + 40
    end
end
...
-- LISTA DE CONFIGURAÇÃO (IDIOMAS - SEM BOTÃO VOLTAR)
...
for i, idioma in pairs(idiomas) do
    ...
    btnIdioma.MouseButton1Click:Connect(function()
        ...
        -- Recria os botões do player com o novo idioma
        criarBotoesPlayer()
    end)
