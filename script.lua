...
-- =============================================
-- FUNCAO DE FARM CORRIGIDA (100 OURO POR FASE)
-- =============================================
...
function autoFarm(currentRun)
    ...
    -- PASSA POR TODAS AS 10 FASES E GANHA 100 OURO POR FASE
    for i = 1, 10 do
        ...
        if Stage then
            ...
            if DarknessPart then
                ...
                faseAtual = i
                ouroTotal = ouroTotal + 100 -- +100 por fase
                print("💰 Fase " .. i .. " completada! +100 ouro")
                atualizarUI()
            end
        end
    end

    -- VAI PARA O BAÚ E GANHA MAIS 100 OURO
        ...
        if TheEnd then
            ...
            if GoldenChest then
                ...
                if Trigger then
                    ...
                    if luzMudou then
                        ouroTotal = ouroTotal + 100 -- +100 do bau
