...
-- =============================================
-- FUNCOES DOS EFEITOS CORRIGIDAS
-- =============================================
...
-- FUNCOES DE UTILIDADES CORRIGIDAS
function escudoLoop()
    spawn(function()
    ...
    spawn(function()
        while getgenv().CoringaFarm.AndarAgua do
            ...
            if root and humanoid then
                -- Cria bloco embaixo do jogador (como no auto farm)
...
-- FUNCAO ESPIAR CORRIGIDA (CAMERA DO JOGADOR)
